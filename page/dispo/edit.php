              ...
              <form method="POST">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <textarea type="text" class="form-control" name="isi_dispo"><?php echo $data['isi_dispo'];?></textarea>
                  </div>
                  <div class="form-group col-md-6">
                    <label>Catatan</label>
                  ...
                  <div class="form-group">
                    ...
                    <?php $sifat = $data['sifat']; ?>
                    <select class="form-control" name="sifat">
                    <option <?php echo ($sifat == 'Biasa') ? "selected": "" ?>>Biasa</option>
                    <option <?php echo ($sifat == 'Penting') ? "selected": "" ?>>Penting</option>
                    <option <?php echo ($sifat == 'Segera') ? "selected": "" ?>>Segera</option>
                    <option <?php echo ($sifat == 'Rahasia') ? "selected": "" ?>>Rahasia</option>
                ...
                <div class="card-footer">
                  ...
                  <a href="?page=dispo&id=<?php echo $data['id']; ?>" class="btn btn-secondary">Batal</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
